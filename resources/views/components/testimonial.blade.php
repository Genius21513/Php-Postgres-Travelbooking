<section class="sm:px-6 lg:px-8 py-8">
    <div class="bg-indigo-800 md:grid md:grid-cols-2 md:px-6 lg:px-8">
        <div class="py-6 px-4 sm:px-6 md:flex md:flex-col md:py-8 md:pl-0 md:pr-5 md:border-r md:border-indigo-900 lg:pr-8">
            <div class="md:flex-shrink-0">
                <img class="h-12" src="https://tailwindui.com/img/logos/tuple-logo-indigo-300.svg" alt="Business Trip">
            </div>
        ...
        <div class="py-12 px-4 border-t-2 border-indigo-900 sm:px-6 md:py-8 md:pr-0 md:pl-5 md:border-t-0 md:border-l lg:pl-8">
            <div class="md:flex-shrink-0">
                <img class="h-12" src="https://tailwindui.com/img/logos/workcation-logo-indigo-300.svg" alt="Vacation Rental">
            </div>
            <blockquote class="mt-6 md:flex-grow md:flex md:flex-col">
                <div class="relative text-lg font-medium text-white md:flex-grow">
