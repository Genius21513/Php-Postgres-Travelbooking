            ...
            <div class="p-8 bg-white border border-gray-100 shadow-md rounded-xl">
                ...
                <div class="items-center gap-2 md:flex">
                    ...
                    <div class="relative rounded-md">
                        ...
                        <input type="text" class="block w-full py-3 pl-10 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-md" placeholder="Check-In"> -->
                    ...
                    <div class="relative rounded-md">
                        ...
                        <input type="text" class="block w-full py-3 pl-10 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-md" placeholder="Check-Out">
                    </div>
